...
If (Form:C1466.recordCanBeSaved)
	If ($entity.isNew())
		OBJECT SET TITLE:C194(*; "@_UNLOCK_@"; Localized string:C991("New"))
	Else 
		OBJECT SET TITLE:C194(*; "@_UNLOCK_@"; Localized string:C991("Lock"))
	End if 
Else 
	OBJECT SET TITLE:C194(*; "@_UNLOCK_@"; Localized string:C991("Unlock"))
End if 
