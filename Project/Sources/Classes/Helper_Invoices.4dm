...
Function setContext($wp : Object)
	If (Count parameters:C259=0)
		$wp:=This:C1470.WP
	End if 
	$context:=This:C1470.invoice  // just use the full invoice. We could add more data 
...
Function getPageImages()->$pages : Collection
	$wp:=This:C1470.WP
	$pageCount:=WP Get page count:C1412($wp)
...
Function createPDF_noConditions($pfad : Text)
	$wp:=WP New:C1317(This:C1470.WP)
	WP EXPORT DOCUMENT:C1337($wp; $pfad; wk pdf:K81:315)
	
Function createPDF($pfad : Text)
	$wp:=WP New:C1317()
	$col:=This:C1470.getPageImages()
	C_PICTURE:C286($conditions)
	$conditionsentity:=ds:C1482.Document_Templates.query("Name='conditions'")
...
Function print_white()
	...
	$obj:=WP Get element by ID:C1549($wp; "LogoBackground")
